...
My research interest lies in the mathematical modeling, computation and numerical analysis with applications to condensed matter physics. I have been working on modeling the electronic properties of two-dimensional materials, especially twisted bilayer graphene (TBG). I greatly appreciate the support from [UMN Doctoral Dissertation Fellowship](https://grad.umn.edu/news-events/news-overview/2024-2025-doctoral-dissertation-fellows).
